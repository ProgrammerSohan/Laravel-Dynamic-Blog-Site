<div class="py-5 bg-dark text-white">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h5>Programmer Sohan Blog Site</h5>
                <div class="underline"></div>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat illum tempore sit nihil, mollitia a est accusantium eligendi, vel recusandae iure. Vero ab commodi dolor alias aliquam, dolorem placeat quasi!
                </p>
            </div>
            <div class="col-md-3">
                <h5>Quick Links</h5>
...
<div class="py-2 bg-gray">
    <div class="container text-center">
        <p class="mb-0">
            &copy; Copyright at <a href="https://www.programmersohan.com/">Programmer Sohan.</a>
            All right reserved.
            Designed and Developed by Programmer Sohan {{ date('d-m-Y')}}.
